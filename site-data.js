/* =========================================================================
   Greg Promo Media — site configuration & content
   Single source of truth. Previously this file had three separate
   "window.GP_SITE.textMap = Object.assign(...)" patches (v16 / v19 / v22)
   layered on top of each other with duplicate keys — the browser only
   ever used the last value for each duplicate anyway. This is that same
   final, resolved data set, merged once, with duplicates removed.
   ========================================================================= */
...
window.GP_SITE = {
  ...
  "contactEmail": "contact@gregpromoht.com",
  "bookingEmail": "contact@gregpromoht.com",
  "contactPhone": "+1 (954) 931-1514",
  "contactPhoneHref": "+19549311514",
  "formspreeEndpoint": "",
  "supabase": {
  ...
  "soccerApi": {
    ...
    "competitions": [
      ...
      },
      {
        ...
        "frLabel": "Premier League",
        "country": "England",
        "frCountry": "Angleterre",
        "accent": "#2347ff"
      },
      {
        "key": "champions",
        "label": "Champions League",
        "frLabel": "Ligue des Champions",
        "country": "Europe",
        "frCountry": "Europe",
        "accent": "#173bba"
      },
      ...
      },
      {
        ...
        "frLabel": "Saudi Pro League",
        "country": "Saudi Arabia",
        "frCountry": "Arabie Saoudite",
        "accent": "#0a8f4d"
      },
      {
        "key": "worldcup",
        "label": "World Cup",
        "frLabel": "Coupe du Monde",
        "country": "FIFA",
        "frCountry": "FIFA",
        "accent": "#d9a72b"
      }
  ...
  "i18n": {
    "fr": {
      ...
      "navSports": "Sports",
      "navGallery": "Galerie",
      "navAdvertise": "Promotion",
      "navCommunity": "Communauté",
      "navContact": "Contact",
      "navAbout": "À propos",
      "menuLabel": "Menu",
      "sportsKicker": "Bureau Sports",
      "sportsHeroTitle": "Scores, classements et culture locale.",
      "sportsHeroText": "Un tableau clair pour suivre les grandes ligues et garder les moments du Haitian All-Star Game au centre.",
      "footballBoard": "Tableau football",
      "tableMatches": "classement & matchs",
      "seasonLabel": "Saison",
      "refreshBoard": "Actualiser",
      "leaguesLabel": "Ligues",
      "leagueHelp": "Choisissez une ligue et une saison. Les données disponibles se chargent automatiquement.",
      "officialTable": "Table officielle",
      "standingsTitle": "Classement",
      "recentFixtures": "Derniers résultats",
      "matchesTitle": "Matchs",
      ...
      "loadingScorers": "Chargement des buteurs...",
      "allStarLabel": "Haitian All-Star Game",
      "localGameTitle": "Le match local reste au centre.",
      "localGameText": "Les ligues mondiales donnent le rythme. Mais l’identité sportive de Greg Promo se construit aussi avec le terrain, les équipes, les drapeaux, les supporters, les DJ et les vraies histoires de communauté.",
      "openRecap": "Voir le recap All-Star",
      ...
      "ctaRecap": "Voir le recap",
      "ctaVideo": "Voir les vidéos",
      "ctaPromo": "Réserver une promo",
      ...
      "proofTitle": "Le travail se voit.",
      "latestTitle": "Dernières histoires",
      "sportsTitle": "Sports Desk",
      "loveTitle": "Messages de la communauté",
      "uploadTitle": "Ajouter une photo d’activité",
      "uploadText": "Partagez un moment de l’événement. Les photos peuvent être validées avant d’apparaître dans la galerie publique.",
      "uploadName": "Votre nom",
      "uploadActivity": "Nom de l’activité",
      "uploadCity": "Ville",
      "uploadCaption": "Légende",
      "uploadFile": "Photo",
      "uploadSubmit": "Envoyer la photo",
      "uploadPending": "Photo envoyée. Elle apparaîtra après validation.",
      "uploadReady": "Photo publiée dans la galerie.",
      "uploadSetup": "Les envois publics seront bientôt disponibles.",
      "galleryTitle": "Galerie publique",
      "galleryText": "Photos officielles et moments partagés autour des activités Greg Promo.",
      "sportsLocked": "Les saisons 2025/2026 demandent un plan API supérieur. La page reste propre et charge les saisons disponibles.",
      "birthdayTitle": "Film d’anniversaire",
      "birthdayText": "Ajoutez la vidéo d’anniversaire dans les assets pour afficher un moment plus personnel de Greg Promo.",
      "aboutGregTitle": "Antoine Gregory, dit Greg Promo",
      "aboutGregText": "Originaire de Pétion-Ville, Antoine Gregory a construit Greg Promo comme une vitrine pour la culture, les événements, les artistes et la jeunesse haïtienne. Sa plateforme avance avec une idée simple : montrer les moments réels avec discipline, rapidité et respect de la communauté.",
      "menuOpen": "Ouvrir le menu",
      "formNamePlaceholder": "Nom",
      "formEmailPlaceholder": "Email",
      "formMessagePlaceholder": "Dites-nous ce que vous voulez construire",
      "formSubjectPromotion": "Demande de promotion",
      "formSubjectEvent": "Couverture événementielle",
      "formSubjectSponsor": "Forfait sponsor",
      "formSubjectArtist": "Lancement artiste"
    },
    "en": {
      "navHome": "Home",
      "navArticles": "Articles",
      ...
      "navAbout": "About",
      "menuLabel": "Menu",
      "sportsKicker": "Sports Desk",
      "sportsHeroTitle": "Scores, tables and local culture.",
      "sportsHeroText": "A clean board for major leagues while keeping the Haitian All-Star Game at the center.",
      "footballBoard": "Football board",
      "tableMatches": "table & matches",
      "seasonLabel": "Season",
      "refreshBoard": "Refresh",
      "leaguesLabel": "Leagues",
      "leagueHelp": "Choose a league and season. Available data loads automatically.",
      "officialTable": "Official table",
      "standingsTitle": "Standings",
      "recentFixtures": "Recent results",
      ...
      "allStarLabel": "Haitian All-Star Game",
      "localGameTitle": "The local game stays at the center.",
      "localGameText": "Global leagues set the rhythm. Greg Promo’s sports identity also lives through the field, teams, flags, supporters, DJs and real community stories.",
      "openRecap": "Open All-Star recap",
      ...
      "ctaRecap": "View recap",
      "ctaVideo": "Watch videos",
      "ctaPromo": "Book promotion",
      "modelTitle": "A media voice, a presence, a community.",
      "modelText": "Greg Promo brings media coverage, sports, events, video, promotion and artist visibility into one platform.",
      "proofTitle": "The work is visible.",
      "latestTitle": "Latest stories",
      "sportsTitle": "Sports Desk",
      "loveTitle": "Community messages",
      "uploadTitle": "Add an activity photo",
      "uploadText": "Share a moment from the event. Photos may be approved before appearing in the public gallery.",
      "uploadName": "Your name",
      "uploadActivity": "Activity name",
      "uploadCity": "City",
      "uploadCaption": "Caption",
      "uploadFile": "Photo",
      "uploadSubmit": "Submit photo",
      "uploadPending": "Photo submitted. It will appear after approval.",
      "uploadReady": "Photo published in the gallery.",
      "uploadSetup": "Public submissions will be available soon.",
      "galleryTitle": "Public gallery",
      "galleryText": "Official photos and submitted moments around Greg Promo activities.",
      "sportsLocked": "2025/2026 seasons require a higher API plan. This page stays clean and loads the seasons available to your account.",
      "birthdayTitle": "Birthday Film",
      "birthdayText": "Add the birthday video to assets to display a more personal Greg Promo moment.",
      "aboutGregTitle": "Antoine Gregory, known as Greg Promo",
      "aboutGregText": "Originally from Pétion-Ville, Antoine Gregory built Greg Promo as a window into Haitian culture, events, artists and youth energy. The platform moves with a simple idea: show real moments with discipline, speed and respect for the community.",
      "menuOpen": "Open menu",
      "formNamePlaceholder": "Name",
      "formEmailPlaceholder": "Email",
      "formMessagePlaceholder": "Tell us what you want to build",
      "formSubjectPromotion": "Promotion inquiry",
      "formSubjectEvent": "Event coverage",
      "formSubjectSponsor": "Sponsor package",
      "formSubjectArtist": "Artist rollout"
    }
  },
  "demoSports": {
    "matches": [
      ...
      },
      {
        ...
        "score": "vs",
        "away": "Influencers",
        "status": "All-Star Game"
      },
      {
        "home": "Greg Promo All-Stars",
        "score": "Culture",
        "away": "Miami Crowd",
        "status": "Local board"
      }
    ...
    "scorers": [
      ...
      {
        "name": "Featured All-Star",
        "team": "Greg Promo Media",
        "goals": 1
      }
    ]
  },
  "textMap": {
    ...
    "Videos from the assets folder.": {
      "fr": "Vidéos des activités Greg Promo.",
      "en": "Greg Promo activity videos."
    },
    "No YouTube needed. Upload MP4 files to assets/videos/ using the file names below.": {
      "fr": "Recaps, coulisses, performances et moments forts autour des activités Greg Promo.",
      "en": "Recaps, behind-the-scenes, performances and highlight moments around Greg Promo activities."
    },
    ...
    "Official visuals stay first. Community uploads appear here after Supabase is connected and approved.": {
    ...
    "Live leagues. Local culture. One board.": {
      "fr": "Ligues, classements et culture locale au même endroit.",
      "en": "Leagues, tables and local culture in one place."
    },
    "Global football data, clean league tables, and local All-Star Game recaps in one sports desk.": {
      "fr": "Classements, résultats et moments All-Star réunis dans une page claire.",
      "en": "Standings, results and All-Star moments together in one clean page."
    },
    "Football board": {
      "fr": "Tableau football",
      "en": "Football board"
    ...
    "Choose a league and season. When live data is available, the table updates automatically.": {
    ...
    "The local game still comes first.": {
      "fr": "Le jeu local reste au centre.",
      "en": "The local game still comes first."
    },
    "The live board is useful for global leagues. But the real Greg Promo sports identity is the All-Star Game: the walkouts, the women’s team, the flags, the crowd, the DJs and the people on the field.": {
      "fr": "Les ligues mondiales ajoutent du contexte, mais l’identité sportive de Greg Promo reste l’All-Star Game : les entrées, l’équipe féminine, les drapeaux, la foule, les DJs et les gens sur le terrain.",
      "en": "Global leagues add context, but Greg Promo’s sports identity stays rooted in the All-Star Game: walkouts, the women’s team, flags, crowds, DJs and the people on the field."
    },
    "Open All-Star recap": {
      "fr": "Voir le recap All-Star",
      "en": "Open All-Star recap"
    },
    ...
    "A personal piece for Greg Promo’s image — more private, more stylish, and built for the brand.": {
      "fr": "Un moment personnel pour l’image de Greg Promo — plus intime, plus élégant, pensé pour la marque.",
      "en": "A personal piece for Greg Promo’s image — more private, more stylish, and built for the brand."
    },
    ...
    "Public submissions": {
      "fr": "Partages publics",
      "en": "Public submissions"
    },
    "Invite people to send their activity photos. Approved submissions can appear inside the public gallery and keep the site alive after every event.": {
      "fr": "Invitez le public à envoyer ses photos d’activité. Les photos validées peuvent apparaître dans la galerie publique et garder le site vivant après chaque événement.",
      "en": "Invite people to submit activity photos. Approved submissions can appear in the public gallery and keep the site alive after every event."
    },
    "Share a photo": {
    ...
    "Promotion packages": {
      "fr": "Forfaits promotion",
      "en": "Promotion packages"
    },
    "Story promo, event campaign, artist rollout, business spotlight and sponsor visibility can be organized from one clean contact flow.": {
      "fr": "Story promo, campagne événementielle, lancement artiste, visibilité business et sponsoring peuvent être organisés depuis un parcours clair.",
      "en": "Story promo, event campaign, artist rollout, business spotlight and sponsor visibility can all start from one clean contact flow."
    },
    "Book promotion": {
    ...
    "Built for real culture moments.": {
      "fr": "Conçu pour les vrais moments culturels.",
      "en": "Built for real culture moments."
    },
