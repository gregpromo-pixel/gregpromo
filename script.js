...
function translateExactText(){
  ...
  const walker = document.createTreeWalker(document.body, NodeFilter.SHOW_TEXT, {
    acceptNode(node){
      ...
      if(!parent || ['SCRIPT','STYLE','CODE','TEXTAREA','INPUT','SELECT','OPTION'].includes(parent.tagName)) return NodeFilter.FILTER_REJECT;
...
const menuBtn=document.querySelector('[data-menu-btn]'); const menu=document.querySelector('[data-menu]'); menuBtn?.addEventListener('click',()=>menu?.classList.toggle('open'));
